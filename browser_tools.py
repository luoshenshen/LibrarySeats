...
def get_layout_header(cookie, time):
    header = {
        'Host': 'wechat.laixuanzuo.com',
        'Connection': 'keep-alive',
        'Cache-Control': 'max-age=0',
        ...
        'Accept-Encoding': 'gzip, deflate',
        'Accept-Language': 'zh-CN,zh;q=0.8,en-US;q=0.6,en;q=0.5;q=0.4',
        'Cookie': 'wechatSESS_ID=' + str(cookie) + '; FROM_TYPE=weixin; Hm_lvt_7838cef374eb966ae9ff502c68d6f098=' + str(int(time)) + '; Hm_lpvt_7838cef374eb966ae9ff502c68d6f098=' + str(int(time)),
        'If-Modified': 'Thu, 01 Jan 1970 00:00:00GMT',
    }
    return header
...
def get_prereserve_header(cookie, time):
    header = {
        ...
        'Accept-Encoding': 'gzip, deflate',
        'Accept-Language': 'zh-CN,zh;q=0.8,en-US;q=0.6,en;q=0.5;q=0.4',
        'Cookie': 'wechatSESS_ID=' + str(cookie) + '; FROM_TYPE=weixin; Hm_lvt_7838cef374eb966ae9ff502c68d6f098=' + str((int(time) + 10)) + '; Hm_lpvt_7838cef374eb966ae9ff502c68d6f098=' + str((int(time) + 20)),
    }
    return header
...
def get_today_header(cookie, time):
    header = {
        'Host': 'wechat.laixuanzuo.com',
        'Connection': 'keep-alive',
...
def tomorrow_imgs_header(cookie):
    tomorrow_img_header = {
        'Host': 'wechat.laixuanzuo.com',
        'Connection': 'keep-alive',
        'Cache-Control': 'max-age=0',
